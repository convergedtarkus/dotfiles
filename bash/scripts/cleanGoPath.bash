...
domainFoldersToRemove=$(find $GOPATH/src -type d -mindepth 1 -maxdepth 1 $cleanGoPathDomainProtected | tr '\n' ' ')

githubUsersToRemove=$(find $GOPATH/src/github.com -type d -mindepth 1 -maxdepth 1 $cleanGoPathGithubUserProtected | tr '\n' ' ')

removalString=""
if [[ "$domainFoldersToRemove" != "" ]]; then
	echo "Domain folders to remove: $(echo $(_prettyPrintGoPackagePath "$domainFoldersToRemove"))"
...
if [[ "$githubUsersToRemove" != "" ]]; then
	echo "Github user folders to remove: $(echo $(_prettyPrintGoPackagePath "$githubUsersToRemove"))"
